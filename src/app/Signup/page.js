    ...
    return (
        <div className="min-h-screen flex justify-center items-center bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-96">
                <h1 className="text-3xl font-bold text-purple-600 text-center mb-6">VibePals</h1>
                ...
                <p className="text-center text-sm mt-4">
                    Have an account? <a href="/Login" className="text-purple-600 hover:underline">Login here</a>
                </p>
            </div>
        </div>
    );
